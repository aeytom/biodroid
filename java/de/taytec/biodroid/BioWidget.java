...
public class BioWidget extends AppWidgetProvider {
    ...
    public void onAppWidgetOptionsChanged(Context context, AppWidgetManager appWidgetManager, int appWidgetId, Bundle newOptions) {
        int width = newOptions.getInt(AppWidgetManager.OPTION_APPWIDGET_MAX_WIDTH, 110);
        int height = newOptions.getInt(AppWidgetManager.OPTION_APPWIDGET_MAX_HEIGHT, 40);
        ...
        Bitmap graphBitmap = Bitmap.createBitmap((int) Graph.calculateDpToPixel(width, context), (int) Graph.calculateDpToPixel(height, context), Bitmap.Config.ARGB_8888);
        Graph graph = new Graph(context, core);
        graph.setTextEnabled(false).setBackgroundAlpha(50).draw(graphBitmap);
        ...
        views.setOnClickPendingIntent(R.id.wdg_image, pendingIntent);
